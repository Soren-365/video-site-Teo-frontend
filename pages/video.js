...
class Index extends React.Component {
    ...
    componentDidMount() {
        ...
        try {
            ...
            this.setState({vid_id: nodeid, vid_link: "/video/video.mp4"})
                ...
                <ApolloProvider client={apolloClient}>
                    <div>
                     ...
                     {(loggedInUser.isUserLoggedIn) &&
                        ...
                        <video src="/video/video.mp4" id="id" width="640" height="360" type='video/mp4' controls controlsList="nodownload" > </video>
